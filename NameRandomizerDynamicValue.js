...
(function () {
    ...
    NameRandomizerDynamicValue = function () {
        ...
        this.evaluate = function () {
            ...
            else if (this.arrayType == "companyNames") {
                array = this.maleNames;
            }
            else {
                array = ["Choose either `maleNames`, `femaleNames`,`lastNames` or `companyNames`"];
            }
    ...
    NameRandomizerDynamicValue.identifier = "com.doronkatz.PawExtensions.NameRandomizerDynamicValue";
